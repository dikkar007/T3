...
$(".user_choice").each(function() {
    var $this = $(this);
    $this.click(function() {
        $('.selectedu').toggleClass('not-selectedu');
        $('.selectedu').toggleClass('selectedu');
        $this.toggleClass('not-selectedu');
        $this.toggleClass('selectedu');
